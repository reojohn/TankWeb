...
function fortress_event_title(string $line): string
{
    $map = [
        ...
        'school_id_qr_reset' => 'Personal ID credential reset',
...
function fortress_build_security_context(PDO $pdo, int $userId): array
{
    ...
    $stmt = $pdo->prepare(
        'SELECT username, ' . $policyField . ', school_id_qr_enabled, school_id_qr_updated_at
    ...
    $protectedAssets = [
        ...
        ['fa-id-card', 'Identity verification flow', $schoolIdRequired
            ...
            : 'This account is configured for password-only authentication; Personal ID 2FA is disabled.'],
