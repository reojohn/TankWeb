...
function prefetchLegacyPage(page, legacyUrl = '') {
  if (!pagePathMap[page]) return;
  requestFragment(page, legacyUrl).catch(() => {});
}
...
function LegacyParityPage({
  ...
  return React.createElement(React.Fragment, null, loading && !html ? React.createElement("section", {
    ...
    "aria-label": "Syncing FortressAuth page",
    "aria-busy": "true"
  }, React.createElement("span", {
    className: "sr-only"
  }, "Syncing FortressAuth page"), React.createElement("div", {
    className: "v3-skeleton-metrics"
  }, [0, 1, 2, 3].map(item => React.createElement("span", {
    key: item
  }))), React.createElement("div", {
    className: "v3-skeleton-panels"
  }, React.createElement("span", null), React.createElement("span", null))) : null, refreshing && html ? React.createElement("div", {
    className: "v3-inline-sync",
    role: "status"
  }, React.createElement("i", {
    className: "fa-solid fa-spinner fa-spin"
  }), " Syncing\u2026") : null, error ? React.createElement("section", {
...
function CurrentOperator() {
  ...
  return React.createElement(React.Fragment, null, loading && !html ? React.createElement("section", {
    className: "v3-route-skeleton",
    "aria-label": "Syncing Current Operator",
    "aria-busy": "true"
  }, React.createElement("span", {
    className: "sr-only"
  }, "Syncing Current Operator"), React.createElement("div", {
    className: "v3-skeleton-metrics"
  }, [0, 1, 2, 3].map(item => React.createElement("span", {
    key: item
  }))), React.createElement("div", {
    className: "v3-skeleton-panels"
  }, React.createElement("span", null), React.createElement("span", null))) : null, loading && html ? React.createElement("div", {
    className: "v3-inline-sync",
    role: "status"
  }, React.createElement("i", {
    className: "fa-solid fa-spinner fa-spin"
