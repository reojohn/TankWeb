...
<section class="page-hero compact-page-hero"><div><span class="eyebrow">NETWORK ENFORCEMENT</span><h1>Blocked IPs</h1><p>Review database-backed temporary network bans created by brute-force defenses and remove a ban when an administrator has verified the source is safe.</p></div><div class="page-hero-icon danger"><i class="fa-solid fa-ban"></i></div></section>
