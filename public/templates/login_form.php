...
<head>
  ...
  <!-- Login-page-only icon alignment fix so no CSS file needs changing -->
  <style>
  ...
  <main class="auth-shell" role="main">
    ...
    <section class="auth-panel">
      <div class="auth-panel-inner">
        ...
        <?php if (!empty($error)): ?>
          <div class="error-message <?php echo e($error_class ?? ''); ?>" role="alert">
            <span class="alert-icon" aria-hidden="true">!</span>
            <span><?php echo e($error); ?></span>
          </div>
        <?php endif; ?>

        <form class="auth-form" method="post" action="/login.php" autocomplete="off" novalidate>
          ...
          <div class="field-group">
            ...
            <div class="input-shell">
              <span class="input-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="3.6"/><path d="M5.2 20c.6-4.1 3-6.2 6.8-6.2s6.2 2.1 6.8 6.2"/></svg>
              </span>
              <input id="username" name="username" type="text" required maxlength="100" placeholder="Enter username" autocomplete="username">
            </div>
          </div>
          ...
          <div class="field-group">
            ...
            <div class="input-shell">
              <span class="input-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24"><rect x="5" y="10" width="14" height="10" rx="2.5"/><path d="M8.5 10V7.2a3.5 3.5 0 0 1 7 0V10"/><path d="M12 14v2"/></svg>
              </span>
              <input id="password" name="password" type="password" required maxlength="128" placeholder="Enter password" autocomplete="current-password">
              <button class="password-toggle" type="button" id="password-toggle" aria-label="Show password" aria-pressed="false">
                <svg class="eye-open" viewBox="0 0 24 24" aria-hidden="true"><path d="M2.5 12s3.4-5 9.5-5 9.5 5 9.5 5-3.4 5-9.5 5-9.5-5-9.5-5z"/><circle cx="12" cy="12" r="2.6"/></svg>
                <svg class="eye-closed" viewBox="0 0 24 24" aria-hidden="true"><path d="M3 3l18 18"/><path d="M10.6 7.1C11 7 11.5 7 12 7c6.1 0 9.5 5 9.5 5a15.8 15.8 0 01-3.1 3.3"/><path d="M6.1 6.1C3.8 7.7 2.5 12 2.5 12s3.4 5 9.5 5c1.3 0 2.5-.2 3.5-.6"/></svg>
              </button>
            </div>
          </div>
          ...
          <button class="primary-action" type="submit">
            ...
            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 12h13"/><path d="M14 7l5 5-5 5"/></svg>
          </button>
        </form>
