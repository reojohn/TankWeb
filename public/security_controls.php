...
<?php foreach($defenseLayers as $index=>$layer): $detail=$controlDetails[$layer[0]]; ?>
...
<div><i class="fa-solid fa-qrcode"></i><span>Personal ID verification window</span><strong><?= e(fortress_policy_minutes((int)$policy['school_id_verification_window_seconds'])) ?></strong></div>
<div><i class="fa-solid fa-list-ol"></i><span>Personal ID failed-scan limit</span><strong><?= (int)$policy['school_id_session_attempt_limit'] ?> attempts</strong></div>
